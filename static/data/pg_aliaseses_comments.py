...
merged_df = pd.merge(table_aliases, table_columns_aliases, left_on=['table_name'], right_on=['table_name'], how="left")

merged_df_all = pd.merge(merged_df, table_columns_comments, left_on=['table_name', 'column_name'], right_on=['table_name', 'column_name'], how="left")
