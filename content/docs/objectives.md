...
CHIPS was developped to fill a gap on ancient iron metallurgy data reusability ([**Why CHIPS DB?**](#why-chips-db)). This need, and the practical ways to address it, are a piece of the history of archaeological sciences ([**A short history of the DB**](#a-short-history-of-the-db)).
